  ...
  <div class="heading">
    ...
    <div class="btns">
      ...
      <div class="nav-item dropdown">
        <a class="btn btn-lg btn-outline-primary nav-link" href="#" role="button">Live demo <span>&rarr;</span>
          <b>›</b>
        </a>
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" target="_blank" href="#">Page builder</a>
          <a class="dropdown-item" target="_blank" href="#">Frontend</a>
        </div>
      </div>
    </div>
...
Vvveb.Sections.add("hero/hero-2", {
  ...
  <div class="container">
    <div class="row align-items-center justify-content-between">
      <div class="col-lg-6 mb-5 ms-md-5" data-aos="fade-up" data-aos-delay="0">
      ...
      <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
        <a href="https://www.youtube.com/watch?v=t0Q2otsqC4I" class="video-wrap glightbox">
...
Vvveb.Sections.add("hero/hero-3", {
  ...
  <div class="separator bottom">
    ...
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 41" width="100%" preserveAspectRatio="none">  
      <path style="{fill:#fff;}" class="cls-1" d="M0,185l125-26,33,17,58-12s54,19,55,19,50-11,50-11l56,6,60-8,63,15v15H0Z" transform="translate(0 -159)" />
    </svg>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-6 text-end">
        <a class="btn btn-primary mb-3 me-1" href="#carouselExampleIndicators2" role="button" data-bs-slide="prev">
                    ...
                    <div class="login-form" data-v-if-not="component.user_id">
                      ...
                      <a href="#">
                        <span class="btn btn-outline-primary btn-sm">
                          <i class="lni lni-google la-lg"></i>
                        </span>
                      </a>
                      <a href="#">
                        <span class="btn btn-outline-primary btn-sm">
                          <i class="lni lni-facebook la-lg"></i>
                        </span>
                      </a>
                      <hr>
