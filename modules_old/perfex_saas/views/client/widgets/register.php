...
<div class="form-group mtop15 register-saas-info-group" style="display: none;">
    <!-- slug -->
    <?= $can_use_subdomain ? render_input('slug', _l('perfex_saas_register_form_subdomain_id') . perfex_saas_form_label_hint('perfex_saas_create_company_slug_hint', perfex_saas_get_saas_default_host()), '', 'text', ['maxlength' => PERFEX_SAAS_MAX_SLUG_LENGTH, 'placeholder' => 'yourcompany'], [], "text-left tw-mb-4 ", '') : ''; ?>
