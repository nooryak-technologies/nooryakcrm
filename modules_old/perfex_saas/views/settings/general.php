...
<div class="tw-flex tw-flex-col">
    ...
    <?php echo render_textarea('settings[perfex_saas_reserved_slugs]', $label2, empty($reserved_slugs) ? 'www,app,deal,controller,master,ww3,hack' : $reserved_slugs, ['rows' => 2]); ?>
