...
<div class="widget relative tw-mb-8" id="widget-saas_top_stats"
    ...
    <div class="panel_s">
        <div class="panel-body padding-10">
            ...
            <div class="row tw-flex tw-flex-wrap tw-justify-center">
                ...
                <!-- statistic cards -->
                <div class="col-sm-12 col-md-6 col-lg-5 tw-flex tw-flex-wrap">
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                ...
                                <span
                                    class="tw-font-semibold tw-text-neutral-600 tw-shrink-0"><?= $total_companies; ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                ...
                                <span
                                    class="tw-font-semibold tw-text-neutral-600 tw-shrink-0"><?= $total_packages; ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                ...
                                <span
                                    class="tw-font-semibold tw-text-neutral-600 tw-shrink-0"><?= $total_subscriptions; ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                ...
                                <span
                                    class="tw-font-semibold tw-shrink-0 text-danger"><?= app_format_money($invoices_total['overdue'], $invoices_total['currency']); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                ...
                                <span
                                    class="tw-font-semibold text-warning tw-shrink-0"><?= app_format_money($invoices_total['due'], $invoices_total['currency']); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                ...
                                <span
                                    class="tw-font-semibold tw-shrink-0 text-success"><?= app_format_money($invoices_total['paid'], $invoices_total['currency']); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
