...
// Profile
$route['flutex_admin_api/profile'] = 'profile/profile';                             // GET: Request Staff Information           // POST: Update Staff Information
...
$route['flutex_admin_api/kanban_leads'] = 'leads/kanban_leads';                     // GET: Kanban List All Leads
...
$route['flutex_admin_api/invoices/payment']  = 'invoices/payment';                  // POST: Record Invoice Payment

// Expenses
$route['flutex_admin_api/expenses'] = 'expenses/expenses';                          // GET: List All Expenses                    // POST: Add New Expense
$route['flutex_admin_api/expenses/id/(:num)']  = 'expenses/expenses/id/$1';         // GET: Request Expense Information          // PUT: Update Expense Information
$route['flutex_admin_api/expenses/search/(:any)']  = 'expenses/search/search/$1';   // GET: Search Expenses
...
// Staff
$route['flutex_admin_api/staffs'] = 'staffs/staffs';                                // GET: List All Staffs                      // POST: Add New Staffs
$route['flutex_admin_api/staffs/id/(:num)']  = 'staffs/staffs/id/$1';               // GET: Request Staffs Information           // PUT: Update Staffs Information
$route['flutex_admin_api/staffs/search/(:any)']  = 'staffs/search/search/$1';       // GET: Search Staffs
$route['flutex_admin_api/staffs/id/(:num)/transfer_data_to/(:num)']  = 'staffs/staffs/id/$1/transfer_data_to/$2';                // DELETE: Delete Staff Member

// Notifications
$route['flutex_admin_api/notifications'] = 'notifications/notifications';           // GET: List All Notifications

// Miscellaneous
$route['flutex_admin_api/miscellaneous/privacy']              = 'miscellaneous/privacy';              // GET: Request Privacy Policy
$route['flutex_admin_api/miscellaneous/general']              = 'miscellaneous/general';              // GET: Request General Settings Data
