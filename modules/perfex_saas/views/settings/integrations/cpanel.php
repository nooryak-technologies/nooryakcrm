...
<div class="tw-flex tw-flex-col">
    ...
    <div class="row mtop25 tw-mb-4">
        ...
        <div class="col-md-2">
            <div class="onoffswitch">
                <!-- Hidden input to always send 0 when unchecked -->
                <input type="hidden" name="settings[perfex_saas_cpanel_enabled]" value="0">
    ...
    <div id="addondomain_deps" class="<?= $addondoamin_enabled ? '' : 'hidden'; ?>">
        ...
        foreach ($fields as $key => $field) {
            ...
            $attr = $attrs[$field] ?? [];
            unset($attr['type']);
            echo render_input('settings[' . $field . ']', $label, $value, $attrs[$field]['type'] ?? 'text', $attr);
        } ?>
    </div>
