    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="col-lg-7">
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <!-- Pricing page feature lines -->
                                <div class="tw-mt-8 tw-mb-8">
                                    <?php $feature_lines_value = !empty($package->metadata->pricing_feature_lines) ? $package->metadata->pricing_feature_lines : ''; ?>
                                    <div class="form-group">
                                        <label class="control-label">
                                            <?= _l('perfex_saas_pricing_feature_lines'); ?>
                                            <?= perfex_saas_form_label_hint('perfex_saas_pricing_feature_lines_hint'); ?>
                                        </label>
                                        <textarea name="metadata[pricing_feature_lines]" class="form-control" rows="8" placeholder="Lead Management&#10;Customer Management&#10;Sales Management&#10;Project Management&#10;Task Management"><?= htmlspecialchars($feature_lines_value); ?></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <div class="advance-settings hidden">
                                    ...
                                    <!-- priority -->
                                    <?php $value = (isset($package->metadata->priority) ? $package->metadata->priority : 1); ?>
                                    <?= render_input('metadata[priority]', _l('perfex_saas_package_priority'), $value, 'number', ['min' => 0, 'step' => '1']); ?>
                ...
                <?php hooks()->do_action('perfex_saas_before_package_form_close', $package ?? (object)[]); ?>

                <div class="row">
                    <!-- Submit button -->
                    <div class="col-md-12">
                        <div class="panel_s tw-px-4 text-center">
