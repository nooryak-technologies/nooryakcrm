class InvoicesModel {
  InvoicesModel({
    ...
    String? advancePaidCount,
    String? pendingPaymentTotal,
    String? pendingPaymentCount,
    ...
    _overview = overview;
    _data = data;
    _advancePaidTotal = advancePaidTotal;
    _advancePaidCount = advancePaidCount;
    _pendingPaymentTotal = pendingPaymentTotal;
    _pendingPaymentCount = pendingPaymentCount;
  ...
  InvoicesModel.fromJson(dynamic json) {
    ...
    _advancePaidTotal = json['advance_paid_total'];
    _advancePaidCount = json['advance_paid_count'];
    _pendingPaymentTotal = json['pending_payment_total'];
    _pendingPaymentCount = json['pending_payment_count'];
  ...
  List<Invoice>? _data;
  String? _advancePaidTotal;
  String? _advancePaidCount;
  String? _pendingPaymentTotal;
  String? _pendingPaymentCount;
  ...
  String? get advancePaidTotal => _advancePaidTotal;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_overview != null) {
      map['overview'] = _overview?.map((v) => v.toJson()).toList();
    }
    if (_data != null) {
      map['data'] = _data?.map((v) => v.toJson()).toList();
    }
    map['advance_paid_total'] = _advancePaidTotal;
    map['advance_paid_count'] = _advancePaidCount;
    map['pending_payment_total'] = _pendingPaymentTotal;
    map['pending_payment_count'] = _pendingPaymentCount;
