...
class EstimateDetailsModel {
  EstimateDetailsModel({bool? status, String? message, EstimateDetails? data}) {
    _status = status;
    _message = message;
    _data = data;
  }
  ...
  EstimateDetailsModel.fromJson(dynamic json) {
    ...
    _data = json['data'] != null
        ? EstimateDetails.fromJson(json['data'])
        : null;
  }

  bool? _status;
  String? _message;
  EstimateDetails? _data;

  bool? get status => _status;
  String? get message => _message;
  EstimateDetails? get data => _data;
...
class EstimateDetails {
  ...
  EstimateDetails.fromJson(Map<String, dynamic> json) {
    ...
    _formattedNumber = json['formatted_number'];
  ...
  Map<String, dynamic> toJson() {
    ...
    _formattedNumber = map['formatted_number'];
