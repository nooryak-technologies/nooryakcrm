...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($items as $item) {
             ...
             * Item duration
             */
            $itemHTML .= '<td align="right" width="' . $regularItemWidth . '%">' . (! empty($item['duration']) ? e($item['duration']) : '') . '</td>';
    ...
    public function html_headings()
    {
        ...
        $html .= '<th align="right">' . _l('duration') . '</th>';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . _l('duration') . '</th>';
