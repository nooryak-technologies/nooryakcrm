...
defined('APP_MINIMUM_REQUIRED_PHP_VERSION') or define('APP_MINIMUM_REQUIRED_PHP_VERSION', '8.1');
...
if (defined('PERFEX_SAAS_TENANT_BASE_URL')) {
    $config['base_url'] = PERFEX_SAAS_TENANT_BASE_URL;
} elseif (defined('APP_BASE_URL')) {
    $config['base_url'] = APP_BASE_URL;
} else {
    $config['base_url'] = APP_BASE_URL_DEFAULT;
}
...
$config['csrf_exclude_uris'] = ['forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+', 'flutex_admin_api\/.+', 'razorpay/success\/.+'];
 ...
 */
$modules_path = defined('APP_MODULES_PATH') ? APP_MODULES_PATH : (FCPATH . 'modules/');
