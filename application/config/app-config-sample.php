...
*
*/
define('APP_BASE_URL_DEFAULT', 'https://nooryakcrm.com/');
 ...
 */
define('APP_DB_USERNAME_DEFAULT', 'bazaarwa_nooryakcrm');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD_DEFAULT', 'Nooryakcrm7866');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME_DEFAULT', 'bazaarwa_nooryakcrm');
