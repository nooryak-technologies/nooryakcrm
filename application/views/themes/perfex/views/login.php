        ...
        <div class="ny-login-card">
            ...
            <div class="form-group">
                ...
                <div class="ny-input-wrap">
                    ...
                    <input type="text" autofocus="true" class="form-control" name="email" id="email" placeholder="you@example.com" autocomplete="username" value="<?= set_value('email', 'demo-company@gmail.com'); ?>">
                </div>
                <?= form_error('email'); ?>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="ny-input-wrap ny-input-wrap-password">
                    ...
                    <input type="password" class="form-control" name="password" id="password" placeholder="Enter your password" autocomplete="current-password" value="12345678">
