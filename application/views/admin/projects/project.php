...
?>
                            ...
                            <?= render_select('clientid', $project_customer_options, ['id', 'name', 'subtext'], 'project_customer', $project_customer_selected, ['data-live-search' => 'true'], [], '', '', true); ?>
...
?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?= render_input('estimated_hours', 'estimated_days', isset($project) ? $project->estimated_hours : '', 'number'); ?>
                                </div>
                                <div class="col-md-6">
                                    <?php
 $selected = [];
