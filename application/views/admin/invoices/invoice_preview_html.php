        ...
        <div class="col-md-5 col-md-offset-7">
            <table class="table text-right">
                <tbody>
                    ...
                    <?php if ((float) $invoice->advance > 0) { ?>
                    <tr>
                        <td>
                            <span class="tw-font-medium tw-text-neutral-700"><?= _l('advance_paid'); ?></span>
                        </td>
                        <td>
                            <?= e('-' . app_format_money($invoice->advance, $invoice->currency_name)); ?>
                        </td>
                    </tr>
                    <?php } ?>
