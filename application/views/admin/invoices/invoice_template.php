            ...
            <div class="col-md-6">
                <div class="f_client_id">
                    <div class="form-group select-placeholder">
                        <?php if (isset($lead_mode) && $lead_mode) { ?>
                        <label for="leadid" class="control-label"><?= _l('lead'); ?></label>
                        <select id="leadid" name="leadid" data-live-search="true" data-width="100%" class="selectpicker" data-none-selected-text="<?= _l('dropdown_non_selected_tex'); ?>">
                            <option value=""></option>
                            <?php foreach ($leads as $l) {
                                $selected = isset($selected_lead) && $selected_lead == $l['id'] ? 'selected' : '';
                                echo '<option value="' . $l['id'] . '" ' . $selected . '>' . '#'.$l['id'].' - '.htmlspecialchars($l['lead_name']) . '</option>';
                            } ?>
                        </select>
                        <?php } else { ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p class="bold tw-text-lg tw-font-semibold">
                            <?= _l('invoice_bill_to'); ?>
                        </p>
                        <address class="tw-text-base">
...
?>
                        <th width="8%" align="right" class="qty">
                            <?= e($qty_heading); ?>
                        </th>
...
?>
                    ...
                    <?php if (isset($invoice) || isset($add_items)) {
                        ...
                        foreach ($add_items as $item) {
                            ...
                            $table_row .= '<td><input type="text" onblur="calculate_total();" onchange="calculate_total();" data-quantity name="' . $items_indicator . '[' . $i . '][qty]" value="' . $item['qty'] . '" class="form-control">';
                            ...
                            $table_row .= '</td>';
                            $table_row .= '<td><input type="text" name="' . $items_indicator . '[' . $i . '][duration]" placeholder="' . _l('duration') . '" value="' . (isset($item['duration']) ? $item['duration'] : '') . '" class="form-control"></td>';
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="row">
                                <div class="col-md-7">
                                    <span class="bold tw-text-neutral-700">Advance</span>
                                </div>
                                <div class="col-md-5">
                                    <input type="number" data-toggle="tooltip"
                                        data-title="<?= _l('numbers_not_formatted_while_editing'); ?>"
                                        value="<?= isset($invoice) ? $invoice->advance : 0; ?>"
                                        class="form-control pull-left" name="advance" min="0">
                                </div>
                            </div>
                        </td>
                        <td class="advance-display" style="text-align:right;color:#e74c3c;"></td>
                    </tr>
                    <tr>
                        <td><span
                    ...
                    <tr id="balance_due_row">
                        <td><span class="bold" style="color:#e74c3c;">Balance Due :</span></td>
                        <td class="balance-due" style="text-align:right;color:#e74c3c;font-weight:bold;"></td>
                    </tr>
