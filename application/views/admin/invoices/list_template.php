            ...
            <div class="_buttons sm:tw-space-x-1 rtl:sm:tw-space-x-reverse">
                ...
                <div class="display-block pull-right tw-space-x-0 sm:tw-space-x-1.5 rtl:tw-space-x-reverse">
                    ...
                    <app-filters id="<?= $invoices_table->id(); ?>"
                        ...
                        :rules="extra.invoicesRules || <?= app\services\utilities\Js::from($this->input->get('status') ? $invoices_table->findRule('status')->setValue([$this->input->get('status')]) : ($this->input->get('advance_paid') ? $invoices_table->findRule('advance_paid')->setValue('1') : ($this->input->get('pending_payment') ? $invoices_table->findRule('pending_payment')->setValue('1') : ($this->input->get('not_sent') ? $invoices_table->findRule('sent')->setValue('0') : [])))); ?>"
